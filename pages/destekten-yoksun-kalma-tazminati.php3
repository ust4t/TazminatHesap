                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div style="display: flex; align-items: flex-end; height: 100%" class="">
                                            <button id="asgari-ucret" class="btn btn-outline-primary btn-sm mb-1" step="0.01" style="display: block; width: 100%">Asgari Maaş</button
                                        </div>
                                    </div>
                                    <!--
                                    <div class="col-md-6">
...
function addAgi() {
        ...
        let agiCount = $("#agis > div").length;
        
            let blank_agi = $("#agi-blank").html(),
                countDiv = agiCount;
            blank_agi = blank_agi.replace("agis[][name]", "agis[" + (countDiv) + "][name]")
            blank_agi = blank_agi.replace("agis[][gender]", "agis[" + (countDiv) + "][gender]")
            blank_agi = blank_agi.replace("agis[][birthday]", "agis[" + (countDiv) + "][birthday]")
            blank_agi = blank_agi.replace("agis[][uni]", "agis[" + (countDiv) + "][uni]")
            blank_agi = blank_agi.replace("agis[][uni]", "agis[" + (countDiv) + "][disabled]")

            $('#agis').append(blank_agi);
